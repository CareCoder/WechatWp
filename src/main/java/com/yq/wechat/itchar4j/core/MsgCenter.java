...
import com.yq.wechat.itchar4j.msgHandler.IMsgHandlerFace;
import com.yq.wechat.itchar4j.utils.enums.MsgCodeEnum;
import com.yq.wechat.itchar4j.utils.enums.MsgTypeEnum;
...
public class MsgCenter {
	 ...
	 * @return
	 */
	public static JSONArray produceMsg(JSONArray msgList, Core core) {
	 ...
	 * @param msgHandler
	 */
	public static void handleMsg(IMsgHandlerFace msgHandler, BaseMsg msg, Core core) {
		if (msg.getType() != null) {
			try {
				if (msg.getType().equals(MsgTypeEnum.TEXT.getType())) {
					String result = msgHandler.textMsgHandle(msg);
					MessageTools.sendMsgById(result, msg.getFromUserName(), core);
