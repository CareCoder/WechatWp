package com.yq.wechat.itchar4j.utils.tools;
...
import com.yq.wechat.itchar4j.beans.RecommendInfo;
import com.yq.wechat.itchar4j.core.Core;
import com.yq.wechat.itchar4j.utils.Config;
...
import com.yq.wechat.itchar4j.utils.enums.VerifyFriendEnum;
...
public class MessageTools {
	...
	private static JSONObject webWxUploadMedia(String filePath, Core core) {
		...
		HttpEntity entity = MyHttpClient.getInstance().doPostFile(url, reqEntity);
		if (entity != null) {
			try {
